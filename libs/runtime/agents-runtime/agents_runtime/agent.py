...
from agents_runtime.mcp_tool import load_mcp_tools_from_configs
from agents_runtime.models import create_model, ModelResult
...
from agents_runtime.streams import StreamParserState, parse_stream_part
...
class RuntimeAgent:
    ...
    def _thread_backend_factory(self, tool_runtime: Any) -> ThreadRuntimeBackend:
        ...
        try:
            ...
            # Fall back to the tool runtime when no runnable config is active.
            pass
