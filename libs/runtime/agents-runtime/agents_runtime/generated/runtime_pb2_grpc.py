...
class AgentExecutorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Run = channel.stream_stream(
                '/agents.runtime.v1.AgentExecutor/Run',
...
def add_AgentExecutorServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'agents.runtime.v1.AgentExecutor', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('agents.runtime.v1.AgentExecutor', rpc_method_handlers)
...
class AgentTelemetryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RunTelemetry = channel.stream_stream(
                '/agents.runtime.v1.AgentTelemetry/RunTelemetry',
                request_serializer=runtime__pb2.ClientMessage.SerializeToString,
...
def add_AgentTelemetryServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'agents.runtime.v1.AgentTelemetry', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('agents.runtime.v1.AgentTelemetry', rpc_method_handlers)
...
class ResourceSyncStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SyncSkill = channel.unary_unary(
                '/agents.runtime.v1.ResourceSync/SyncSkill',
        ...
        self.GetAgentGraph = channel.unary_unary(
                '/agents.runtime.v1.ResourceSync/GetAgentGraph',
        ...
        self.RemoveResource = channel.unary_unary(
                '/agents.runtime.v1.ResourceSync/RemoveResource',
                request_serializer=runtime__pb2.RemoveResourceRequest.SerializeToString,
                response_deserializer=runtime__pb2.SyncResponse.FromString,
                _registered_method=True)
        self.Health = channel.unary_unary(
                '/agents.runtime.v1.ResourceSync/Health',
...
def add_ResourceSyncServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'agents.runtime.v1.ResourceSync', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('agents.runtime.v1.ResourceSync', rpc_method_handlers)
...
class SessionQueryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListSessions = channel.unary_unary(
                '/agents.runtime.v1.SessionQuery/ListSessions',
        ...
        self.GetSession = channel.unary_unary(
                '/agents.runtime.v1.SessionQuery/GetSession',
        ...
        self.GetSessionMessages = channel.unary_unary(
                '/agents.runtime.v1.SessionQuery/GetSessionMessages',
        ...
        self.GetLatestSession = channel.unary_unary(
                '/agents.runtime.v1.SessionQuery/GetLatestSession',
        ...
        self.DeleteSession = channel.unary_unary(
                '/agents.runtime.v1.SessionQuery/DeleteSession',
        ...
        self.ListThreadArtifacts = channel.unary_unary(
                '/agents.runtime.v1.SessionQuery/ListThreadArtifacts',
...
def add_SessionQueryServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'agents.runtime.v1.SessionQuery', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('agents.runtime.v1.SessionQuery', rpc_method_handlers)
