    ...
    try:
        with patch(
            ...
            with patch(
                ...
                with patch(
                    "agents_runtime.agent.MemoryMiddleware",
                    side_effect=lambda **_kwargs: object(),
                ):
                    with patch(
                        "agents_runtime.agent.RuntimeSkillsMiddleware",
                        side_effect=lambda **_kwargs: object(),
                    ):
                        with patch(
                            ...
                            with patch(
                                ...
                                with patch(
                                    ...
                                    with patch(
                                        ...
                                        with patch(
                                            "agents_runtime.agent.get_system_prompt",
...
def test_create_sandbox_runtime_uses_docker_backend() -> None:
    ...
    try:
        with patch(
            "agents_runtime.agent.DockerSandboxBackend.from_spec",
            new=fake_from_spec,
        ):
            runtime = asyncio.run(
                agent._create_sandbox_runtime(
