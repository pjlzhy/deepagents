...
from agents_runtime import proto_codegen
...
def test_build_protoc_args_use_leaf_proto_directory() -> None:
    ...
    output_dir = Path("D:/repo/libs/runtime/agents-runtime/agents_runtime/generated")
...
def test_validate_generated_outputs_returns_top_level_runtime_stubs() -> None:
    ...
    generated_dir = Path(__file__).resolve().parents[2] / "agents_runtime" / "generated"
